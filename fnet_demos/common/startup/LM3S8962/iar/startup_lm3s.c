...
/* weak aliases for handlers, which can be installed */
extern void timer0a_isr(void);
#pragma weak timer0a_isr=default_isr
extern void timer1a_isr(void);
#pragma weak timer1a_isr=default_isr
extern void timer2a_isr(void);
#pragma weak timer2a_isr=default_isr
extern void timer3a_isr(void);
#pragma weak timer3a_isr=default_isr
...
__root const irq_handler_t __vector_table[NVIC_INTERRUPT_MAX+1] @ ".intvec" =
{
    ...
    timer0a_isr,                            /* 19 TIMER0A_IRQn       */ 
    default_isr,                            /* 20 TIMER0B_IRQn       */ 
    timer1a_isr,                            /* 21 TIMER1A_IRQn       */ 
    default_isr,                            /* 22 TIMER1B_IRQn       */ 
    timer2a_isr,                            /* 23 TIMER2A_IRQn       */ 
